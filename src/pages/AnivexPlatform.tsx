...
export default function AnivexPlatform() {
  ...
  // const [, setLocation] = useLocation(); // Disabled for preview without Clerk
        ...
        <div className="flex items-center gap-3">
          ...
          <Show when="signed-out">
            <div className="hidden sm:flex items-center gap-2">
              <button onClick={() => console.log('Sign up clicked')} className="px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-white border border-transparent hover:border-white/10 transition-all">Регистрация</button>
              <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} onClick={() => console.log('Sign in clicked')} className="px-4 py-2 bg-white text-black rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg hover:shadow-white/20 transition-all">Войти</motion.button>
            </div>
          </Show>
          <Show when="signed-in">
